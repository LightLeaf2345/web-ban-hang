...
<body class="bg-[#F8F9FA] text-slate-800 antialiased h-screen w-screen overflow-hidden flex" x-data="{ sidebarOpen: true }">
    ...
    <aside class="bg-white shrink-0 flex flex-col transition-all duration-300 z-20 h-full shadow-[2px_0_12px_rgba(0,0,0,0.02)] border-r border-slate-100" :class="sidebarOpen ? 'w-[220px]' : 'w-[70px]'">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4 flex flex-col gap-1 hide-scroll">
            ...
            <a href="/admin" class="flex items-center gap-3 px-3 py-2.5 transition-all duration-200 <?php echo e(request()->is('admin') ? 'bg-[#C1121F]/10 text-[#C1121F] font-bold rounded-xl' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-semibold rounded-xl'); ?>">
            ...
            <a href="/admin/products" class="flex items-center gap-3 px-3 py-2.5 transition-all duration-200 <?php echo e(request()->is('admin/products*') ? 'bg-[#C1121F]/10 text-[#C1121F] font-bold rounded-xl' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-semibold rounded-xl'); ?>">
            ...
            <a href="/admin/categories" class="flex items-center gap-3 px-3 py-2.5 transition-all duration-200 <?php echo e(request()->is('admin/categories*') ? 'bg-[#C1121F]/10 text-[#C1121F] font-bold rounded-xl' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-semibold rounded-xl'); ?>">
            ...
            <a href="/admin/orders" class="flex items-center justify-between px-3 py-2.5 transition-all duration-200 <?php echo e(request()->is('admin/orders*') ? 'bg-[#C1121F]/10 text-[#C1121F] font-bold rounded-xl' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-semibold rounded-xl'); ?>">
            ...
            <a href="/admin/customers" class="flex items-center gap-3 px-3 py-2.5 transition-all duration-200 <?php echo e(request()->is('admin/customers*') ? 'bg-[#C1121F]/10 text-[#C1121F] font-bold rounded-xl' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-semibold rounded-xl'); ?>">
            ...
            <a href="/admin/promotions" class="flex items-center gap-3 px-3 py-2.5 transition-all duration-200 <?php echo e(request()->is('admin/promotions*') ? 'bg-[#C1121F]/10 text-[#C1121F] font-bold rounded-xl' : 'text-slate-500 hover:bg-slate-50 hover:text-slate-900 font-semibold rounded-xl'); ?>">
...
</html><?php /**PATH C:\Users\ASUS\Downloads\projectphp\HopTacXaPHP_CuaHangQuanAoOnline-main\resources\views/components/admin/layout.blade.php ENDPATH**/ ?>